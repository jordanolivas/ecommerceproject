...
import 'package:budgetapp/widgets/page_1/vuesax_bold_edit_2.g.dart';
import 'package:budgetapp/widgets/page_1/vuesax_bulk_card_remove.g.dart';

class ConfrimationUnlink extends StatefulWidget {
  const ConfrimationUnlink({
    Key? key,
  }) : super(key: key);
  @override
  _ConfrimationUnlink createState() => _ConfrimationUnlink();
}

class _ConfrimationUnlink extends State<ConfrimationUnlink> {
  _ConfrimationUnlink();
              ...
              child: Stack(children: [
                ...
                Positioned(
                  ...
                  child: Container(
                      ...
                      width: 317.0,
                      child: AutoSizeText(
                        'Click yes for Unlink your card.',
                        style: TextStyle(
                          fontFamily: 'Visby CF',
                          fontSize: 14,
                          fontWeight: FontWeight.w500,
