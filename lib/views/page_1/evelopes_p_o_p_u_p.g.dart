...
class EvelopesPOPUP extends StatefulWidget {
  const EvelopesPOPUP({
    Key? key,
  }) : super(key: key);
  @override
  _EvelopesPOPUP createState() => _EvelopesPOPUP();
}

class _EvelopesPOPUP extends State<EvelopesPOPUP> {
  _EvelopesPOPUP();
      ...
      child: Stack(children: [
        ...
        Positioned(
          ...
          child: Container(
              ...
              width: 121.0,
              child: AutoSizeText(
                'Gas Station  envelope ready to use',
                style: TextStyle(
                  fontFamily: 'Visby CF',
                  fontSize: 12,
                  fontWeight: FontWeight.w500,
