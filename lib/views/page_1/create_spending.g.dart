...
import 'package:budgetapp/widgets/page_1/system_keyboards_i_phone_light_alphabetic.g.dart';
import 'package:budgetapp/widgets/page_1/vuesax_bold_calendar.g.dart';

class CreateSpending extends StatefulWidget {
  const CreateSpending({
    Key? key,
  }) : super(key: key);
  @override
  _CreateSpending createState() => _CreateSpending();
}

class _CreateSpending extends State<CreateSpending> {
  _CreateSpending();
    ...
    return Material(
      ...
      child: Stack(children: [
        ...
        Positioned(
          ...
          child: LayoutBuilder(builder: (context, constraints) {
            return SystemKeyboardsIPhoneLightAlphabetic(
              constraints,
            );
          }),
        ),
