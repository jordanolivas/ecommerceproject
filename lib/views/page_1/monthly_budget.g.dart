...
import 'package:budgetapp/widgets/page_1/system_keyboards_i_phone_light_numbers.g.dart';
...
class MonthlyBudget extends StatefulWidget {
  ...
  @override
  _MonthlyBudget createState() => _MonthlyBudget();
}

class _MonthlyBudget extends State<MonthlyBudget> {
  _MonthlyBudget();
    ...
    return Material(
      ...
      child: Stack(children: [
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    Container(
                        ...
                        width: 180.0,
                        child: AutoSizeText(
                          'Lets get you paid an set to go!',
                          style: TextStyle(
                            fontFamily: 'Visby CF',
                            fontSize: 14,
                            fontWeight: FontWeight.w500,
        ...
        Positioned(
          ...
          child: LayoutBuilder(builder: (context, constraints) {
            return SystemKeyboardsIPhoneLightNumbers(
              constraints,
              ovrDelete: Image.asset(
                'assets/images/delete.png',
                package: 'budgetapp',
                height:
                    MediaQuery.of(context).size.height * 0.02131925310407366,
                width: MediaQuery.of(context).size.width * 0.06153877000301932,
                fit: BoxFit.fill,
              ),
            );
          }),
        ...
        Positioned(
          ...
          height: 21.0,
          child: SvgPicture.asset(
            'assets/images/homeindicatorlight.svg',
            package: 'budgetapp',
            height: 21.0,
            width: 414.0,
            fit: BoxFit.none,
