...
import 'package:budgetapp/widgets/page_1/vuesax_bulk_bank.g.dart';
...
class UpdateBank extends StatefulWidget {
  ...
  @override
  _UpdateBank createState() => _UpdateBank();
}

class _UpdateBank extends State<UpdateBank> {
  _UpdateBank();
