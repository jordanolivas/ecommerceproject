...
import 'package:budgetapp/widgets/page_1/vuesax_bold_location.g.dart';

class Googlemapsautocomplete extends StatefulWidget {
  const Googlemapsautocomplete({
    Key? key,
  }) : super(key: key);
  @override
  _Googlemapsautocomplete createState() => _Googlemapsautocomplete();
}

class _Googlemapsautocomplete extends State<Googlemapsautocomplete> {
  _Googlemapsautocomplete();
          ...
          child: Container(
              ...
              child: Stack(children: [
                Positioned(
                  ...
                  height: 381.0,
                  child: Image.asset(
                    'assets/images/basemapimage.png',
                    package: 'budgetapp',
                    height: 381.0,
                    width: 508.0,
                    fit: BoxFit.none,
