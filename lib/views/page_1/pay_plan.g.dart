...
class PayPlan extends StatefulWidget {
  const PayPlan({
    Key? key,
  }) : super(key: key);
  @override
  _PayPlan createState() => _PayPlan();
}

class _PayPlan extends State<PayPlan> {
  _PayPlan();
              ...
              child: Column(
                  ...
                  children: [
                    Container(
                        ...
                        width: 341.0,
                        child: AutoSizeText(
                          'Great, youi’ve choosen the individual plan for \$3 a month',
                          style: TextStyle(
                            fontFamily: 'Visby CF',
                            fontSize: 24,
